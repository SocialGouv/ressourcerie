      ...
      return (
        <div className="subject-answer">
          ...
          <p>
            ...
            <a href="rechercher-commun">sur cette page</a>. Cliquez sur "Uniquement
            les API ouvertes à tous" pour n’afficher que les API ouvertes.
          </p>
          <div className="layout-center">
            <ButtonLink size="large" href="/rechercher-commun" onClick={logClic}>
              Rechercher une API
            </ButtonLink>
          </div>
          <br />
    ...
    case SUBJECT.CHERCHE_API:
      ...
      return (
        <div className="subject-answer">
          ...
          <p>
            Toutes nos API sont visibles{' '}
            <a href="rechercher-commun">sur cette page</a>. Si une API vous
