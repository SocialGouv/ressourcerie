...
const UseCasesSection = ({ UCList } : {UCList:any}) => {
  ...
  return (
    <section id="usecases-triplet">
      <div className="fr-container">
        <h2>Explorez les cas d'usage impliquant les communs de la ressourcerie</h2>
        <div className="uc-grid">
          <div className="taglines-uc">
            {UCList.map((uc:any, index:number) => (
          ...
          <div className="image-uc">
            <div>
              {UCList[activeUC].image ? <img src={`/images/usecases/` + UCList[activeUC].image} alt="" /> : illu}
              <br />
