...
describe('testPages', function () {
    ...
    let mockDriver;
    beforeEach(() => {
        const func = (arg) => __awaiter(this, void 0, void 0, function* () { return arg; });
        mockDriver = {
            get: func,
    ...
    it('return a promise', () => {
        chai_1.assert.instanceOf(axe_test_urls_1.default([], config), Promise);
    });
    it('calls driver.get() for each URL', () => __awaiter(this, void 0, void 0, function* () {
        ...
        yield axe_test_urls_1.default(urls, config);
    ...
    it('waits until the document is ready to have a className added', () => __awaiter(this, void 0, void 0, function* () {
        ...
        yield axe_test_urls_1.default(['http://foo'], config);
