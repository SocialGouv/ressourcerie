      ...
      <div className="fr-container">
        <div className="breadcrumb">
          <a href="/producteurs" className="dont-apply-link-style">
            ⇠ Tous les producteurs de ressources
          </a>
        </div>
    ...
    >
      ...
      <div id="api-list">
        <div className="fr-container text-style">
          <h2>Quelles sont les ressources de {producerWithPronounSafe} ?</h2>
          {apis && apis.length > 0 && (
            <>
              <p>
                Actuellement {producerWithPronounSafe} publie et maintient{' '}
                <b>{apis.length} ressources :</b>
              </p>
          ...
          {partnerApis && partnerApis.length > 0 && (
            <>
              <p>
                ...
                <b>{partnerApis.length} ressources :</b>
              </p>
